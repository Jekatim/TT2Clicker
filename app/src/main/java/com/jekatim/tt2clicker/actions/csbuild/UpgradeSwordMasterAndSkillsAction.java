...
public class UpgradeSwordMasterAndSkillsAction implements Action {

    private static String TAG = "UpgradeSwordMasterAndSkillsAction";
    ...
    public UpgradeSwordMasterAndSkillsAction(ColorChecker colorChecker) {
    ...
    public void perform() {
        ...
        if (colorChecker.isGoToSwordMasterTab(tabCoordinates.x, tabCoordinates.y)) {
            ...
            pause200();
            AutoClickerService.instance.click(upgradeWCSkillCoordinates.x - 65, upgradeWCSkillCoordinates.y);
            pause200();
