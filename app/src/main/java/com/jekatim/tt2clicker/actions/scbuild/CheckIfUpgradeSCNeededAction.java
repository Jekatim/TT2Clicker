...
public class CheckIfUpgradeSCNeededAction extends ActionWithPeriod {

    private static String TAG = "CheckIfUpgradeSCNeededAction";
    ...
    public CheckIfUpgradeSCNeededAction(ColorChecker colorChecker, Strategy strategy, int autoPrestigeAfter) {
        super(185); //sec
    ...
    private void addPush() {
        strategy.addOneTimeAction(new UpgradeSCSkillAction(colorChecker));
        launchesCounter++;
    }
}
