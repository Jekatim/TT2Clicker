...
public class UpgradeSwordMasterAndSkillsToOneAction implements Action {

    private static String TAG = "UpgradeSwordMasterAndSkillsToOneAction";
    ...
    public UpgradeSwordMasterAndSkillsToOneAction(ColorChecker colorChecker) {
